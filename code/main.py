...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='LIT_Highlight', type=str, metavar='MODEL',
    ...
    parser.add_argument('--min_lr', type=float, default=8e-7, metavar='LR',
    ...
    # Provided by code of ConvNeXt. Not used.
    ...
    parser.add_argument('--data_path', default='./train', type=str,
                        help='dataset path')
    parser.add_argument('--eval_data_path', default='./val', type=str,
                        help='dataset path for evaluation')
    parser.add_argument('--nb_classes', default=10575, type=int,
                        help='number of the classification types')
    parser.add_argument('--imagenet_default_mean_and_std', type=str2bool, default=True)
    parser.add_argument('--data_set', default='image_folder', choices=['CIFAR', 'IMNET', 'image_folder'],
                        type=str, help='ImageNet dataset path')
    parser.add_argument('--output_dir', default='./AVEC14_path_11',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./AVEC14_log_11',
...
def main(args):
    ...
    #   ================================================== build model ================================ #
    if args.model == 'LIT_Highlight':
        model = LitHighlight(num_classes=args.nb_classes)
    else:
